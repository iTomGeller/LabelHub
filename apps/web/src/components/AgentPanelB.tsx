...
interface AgentPanelBProps {
  suggestions: AgentSuggestion[];
}

export const AgentPanelB: React.FC<AgentPanelBProps> = ({ suggestions }) => {
  ...
  return (
    <div className="w-full bg-gray-50 p-4 border-l h-full" style={{ borderColor: tokens.colors.border }}>
      <h3 className="font-semibold mb-3 text-sm font-display">🤖 AI Agent 建议 (仅供参考)</h3>
